...
if(($_POST)>0) {
$title = mysqli_real_escape_string($conn,$_REQUEST['quiztitle']); 
$csp = mysqli_real_escape_string($conn,$_REQUEST['csp']); 
$noq = mysqli_real_escape_string($conn,$_REQUEST['noq']); 
$time =mysqli_real_escape_string($conn,$_REQUEST['time']);
 
// Attempt insert query execution
$sql = "INSERT INTO quiz VALUES (DEFAULT,'$noq','$time','$csp','$title')"; 
if($conn->query($sql) === true){
    echo "Records inserted successfully.";
	header("location:trialqz.php");
} else{
